# shopping-cart
Shopping Cart Application using Spring Boot with Hibernate/JPA
...
Alternatively we can use the Spring Boot Maven plugin like so:
...
Swagger is used for the API documentation. It provides the details about the Rest APIs and endpoints along with the operations that can be performed from the respective APIs.
